...
export class HeaderComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.permissions = tempUser.permissions;
  ...
  async makeMenu(): Promise<void> {
    ...
    try{
      ...
      if(this.permissions.findIndex(permission => permission.idpermission === 1) !== -1) {
        // TEST BROKER - Only authorized accounts.
        this.translate.get('HEADER.MENU.TEST').subscribe((text:string) => {
