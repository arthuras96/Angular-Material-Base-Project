...
export class LoginService {
    ...
    user: User = {name: "", email: "", permissions:[], lastlogin: new Date, iduser: 0, idprofile: 0, access_token: "", expires_in: 0, token_type: ""};
    ...
    login(username: string, password: string): Observable<User> {
        ...
        this.user = {name: "Admin Test", email: "test@test", permissions:[], lastlogin: new Date, iduser: 1, idprofile: 1, access_token: "", expires_in: 99999, token_type: ""};
        this.cookieService.set('User', JSON.stringify(this.user), 0.3);
    ...
    getUser(): User {
        if (this.cookieService.check('User')) {
            ...
            if (this.user !== undefined && this.user !== null) {
                ...
                return {name: "", email: "", permissions:[], lastlogin: new Date, iduser: 0, idprofile: 0, access_token: "", expires_in: 0, token_type: ""};
            }
        } else {
            return {name: "", email: "", permissions:[], lastlogin: new Date, iduser: 0, idprofile: 0, access_token: "", expires_in: 0, token_type: ""};
        }
    ...
    logout() {
        this.user = {name: "", email: "", permissions:[], lastlogin: new Date, iduser: 0, idprofile: 0, access_token: "", expires_in: 0, token_type: ""};
